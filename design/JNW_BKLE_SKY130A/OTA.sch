...
N -370 -30 -370 -20 {
lab=AFTER_RESISTOR1}
N 400 -220 630 -220 {lab=VDD}
N 400 -350 400 -220 {lab=VDD}
N 20 -350 400 -350 {lab=VDD}
N 400 -160 400 220 {lab=VSS}
N -0 220 400 220 {lab=VSS}
N 400 -160 630 -160 {lab=VSS}
N 590 -190 590 -160 {lab=VSS}
N 360 -190 360 -160 {lab=VSS}
N 360 -160 400 -160 {lab=VSS}
N 400 -350 840 -350 {lab=VDD}
N 840 -350 840 -220 {lab=VDD}
N 840 -220 1030 -220 {lab=VDD}
N 1030 -220 1210 -220 {lab=VDD}
N 1210 -220 1390 -220 {lab=VDD}
N 840 -150 1030 -150 {lab=VSS}
N 1030 -150 1210 -150 {lab=VSS}
N 1210 -150 1390 -150 {lab=VSS}
N 400 -150 840 -150 {lab=VSS}
...
C {JNW_ATR_SKY130A/JNWATR_PCH_4C5F0.sym} -130 -70 0 0 {name=xMP3[3:0]}
C {JNW_ATR_SKY130A/JNWATR_PCH_4C5F0.sym} 140 -70 0 1 {name=xMP4[3:0]}
C {JNW_ATR_SKY130A/JNWATR_PCH_4C5F0.sym} -40 -230 0 0 {name=xMP2}
C {JNW_ATR_SKY130A/JNWATR_PCH_4C5F0.sym} -330 -230 0 1 {name=xMP1}
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} -50 70 0 1 {name=xMN1}
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} 60 70 0 0 {name=xMN2}
...
C {AAL_MISC_SKY130A/AALMISC_CAP50f.sym} 840 -160 0 0 {name=xCM1}
C {AAL_MISC_SKY130A/AALMISC_CAP50f.sym} 1030 -160 0 0 {name=xCM2}
C {AAL_MISC_SKY130A/AALMISC_CAP50f.sym} 1210 -160 0 0 {name=xCM3}
C {AAL_MISC_SKY130A/AALMISC_CAP50f.sym} 1390 -160 0 0 {name=xCM4 }
